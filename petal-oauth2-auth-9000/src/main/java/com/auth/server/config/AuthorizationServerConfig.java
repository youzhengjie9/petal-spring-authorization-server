...
import com.auth.server.support.handler.CustomAuthenticationSuccessHandler;
import com.auth.server.support.core.CustomDaoAuthenticationProvider;
import com.auth.server.support.CustomeOAuth2AccessTokenGenerator;
import com.auth.server.support.core.CustomeOAuth2TokenCustomizer;
import com.auth.server.support.core.FormIdentityLoginConfigurer;
import com.auth.server.support.password.PasswordAuthenticationConverter;
import com.auth.server.support.password.PasswordAuthenticationProvider;
import com.auth.server.support.sms.SmsAuthenticationConverter;
import com.auth.server.support.sms.SmsAuthenticationProvider;
