package com.petal.oauth2.auth.support.sms;

import com.petal.oauth2.auth.support.base.OAuth2AuthenticationProvider;
...
public class SmsAuthenticationProvider
	...
	public UsernamePasswordAuthenticationToken buildToken(Map<String, Object> reqParameters) {
		String phone = (String) reqParameters.get(Oauth2Constant.SMS_PARAMETER_NAME);
